...
object GeminiService {
    ...
    suspend fun generatePostDescription(title: String, category: String): String = withContext(Dispatchers.IO) {
        kotlinx.coroutines.delay(1500) // Simular procesamiento de IA
        ...
        val templates = mapOf(
            ...
            "Entretenimiento" to "$title es el lugar perfecto para la diversión y el entretenimiento. Ambiente moderno, propuesta variada y una atmósfera vibrante que garantiza una experiencia memorable. Perfecta para grupos, celebraciones o simplemente para disfrutar de una buena noche.",
